<template>
  <div class="page-container">
    ...
    <div style="margin-top: 40vh">
      ...
      <!-- 数据加载完成但为空 -->
      <div v-else-if="noteList.length === 0" class="empty-state">
        <el-empty description="暂无笔记数据"></el-empty>
      </div>
          ...
          <div class="right-mainContent">
            <div class="mainContent-wrapper">
              ...
              <div class="card-publishTime">
                ...
                <span style="margin-left: 5px">{{ formatTime(item.publishTime) }}</span>  <!-- 添加日期格式化 -->
              </div>
              <!-- 数据 -->
...
import {defaultImage, formatTime} from "@/utils/defaultConfig";
...
const loadData = async () => {
  ...
  try {
    ...
    if (res.code === '200') {
      ...
      errorMessage.value = res.msg || '获取笔记列表失败';
...
.mainContent-box:nth-child(1) {
  animation-delay: 0.1s;
}

.mainContent-box:nth-child(2) {
  animation-delay: 0.2s;
}

.mainContent-box:nth-child(3) {
  animation-delay: 0.3s;
}

.mainContent-box:nth-child(4) {
